...
public class RequestTemplate {
	...
	public static String goodBotSystemTemplate(){
		return String.format("""
   			...
   			## 지침
			   1. 사용자가 특정 상태(예: 두드러기)에 대해 질문하면, 해당 상태의 정의, 주요 원인, 증상, 일반적인 치료법, 주의사항을 설명해.
			   2. 원인은 번호(1, 2, 3...)를 사용해 명확히 구분하고, 가능한 경우 구체적인 예시를 포함해.
			   3. 치료법은 증상 완화와 전문의 상담 필요 여부를 구체적으로 언급해.
			   4. 소아 환자의 경우, 소아청소년과를 추가로 추천하거나 주의사항을 강조해.
			   5. 답변은 전문적이면서도 일반인이 이해하기 쉽게 작성해.
			   6. JSON 형식으로 응답하며, 모든 필드(answer, summary, department)를 포함해야 해.
